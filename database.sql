DROP TABLE "TIPE_KAMAR" CASCADE CONSTRAINTS;
...
CREATE TABLE pelamar (
  ...
  JK_PELAMAR VARCHAR2(10) NOT NULL,
  AGAMA_PELAMAR VARCHAR2(45) NOT NULL,
  WNI_PELAMAR VARCHAR2(3) NOT NULL,
  MENIKAH_PELAMAR VARCHAR2(7) NOT NULL,
  PENDIDIKAN_PELAMAR VARCHAR2(45) NOT NULL,
  ALAMAT_PELAMAR VARCHAR2(45) NOT NULL,
  TELEPON_PELAMAR VARCHAR2(20) NOT NULL,
